...
[![GitHub version](https://badge.fury.io/gh/SEEDPlatform%2FSEEDd-status.svg)](https://badge.fury.io/gh/SEEDPlatform%2FSEEDd-status)
[![HitCount](http://hits.dwyl.io/SEEDPlatform/SEEDd-status.svg)](http://hits.dwyl.io/SEEDPlatform/SEEDd-status)
...
| `use_SEEDd_ip`          | Boolean | `true`                | Use the SEED daemon to get the public IP, instead of `$_SERVER`                                 |
...
| `stats_file`            | String | `/tmp/SEEDd-status.data` | File to store stats                                    |
...
| `peercount_file`            | String  | `/tmp/SEEDd-peers.data`  | File to store host-count                                     |
...
| Value                     | Type    | Default    | Explanation                                                 |
|---------------------------|---------|------------|-------------------------------------------------------------|
| `display_SEEDd_uptime` | Boolean | `true`     | Displays the uptime of the SEED daemon                   |
| `SEEDd_process_name`   | String  | `SEEDd` | Name to use when getting the SEED daemon process' uptime |
